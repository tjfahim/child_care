...
$query=
"UPDATE education SET categories='$categories',sub_categories='$sub_categories',title='$title',description='$description',image='$image_file',date=NOW() WHERE id='$pid'";
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-10" style="margin-top: 100px;">
                    ...
                    <?php
                    $id=$_GET['id'];
                        $qu= "SELECT * FROM education WHERE id='$id'";
                        ...
                        <input type="text" value="<?php echo $ro['categories'];?>" name="categorie" >
                       
                        <label for="scategorie">Sub Categorie</label>
                        <input type="text" value="<?php echo $ro['sub_categories'];?>" name="scategorie">
