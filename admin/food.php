<?php 
   ...
   if(isset($_POST['delete'])){
    ...
    $id= $_POST['id'];
    $qu= "DELETE FROM food WHERE id = $id";
...
<body>
    ...
    <div class="container-fluid" >
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-10" style="margin-top: 100px;">
                    <h4 class="my-2">Food</h4>
                    <a href="add_food.php"> <button class="btn btn-primary">Add Food</button>                    
                    </a>
        ...
        '   ;
                        ...
                        $qu= "SELECT * FROM food ORDER BY id DESC";
                        $res=mysqli_query($con,$qu);
                        ...
                        while($row = mysqli_fetch_array($res)){
                            ...
                            <tr>
                                ...
                                <div class='row'>
                                    ...
                                    <a href='update_food.php?id=$id'><button name='edit' class='btn btn-success btn-sm ' type='submit'>Edit</button></a> 
                                    </div>
